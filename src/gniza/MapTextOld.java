...
//	private static final String INDEX_DIR = "tanhuma_index";
	...
	public static void main(String[] args) throws IOException {
		...
		WordsSearcher primaryWordsSearcher = new FuzzySearch(PRIMARY_SLOP, PRIMARY_MAX_EDITS, EXCLUDE_INDEX_DIR);
			...
			while ((line = br.readLine()) != null) {
				...
				for (String word : words) {
					...
					if (wordWindow.size() == SEARCH_WINDOW_SIZE) {
						...
						List<SearchResult> excludedSearchResults = primaryWordsSearcher.Search(wordWindow.toArray(new String[0]));
